...
# Loading libraries
library(tidyverse)    # load BEFORE 'tidyquant' due to conflicts for select()
library(tidyquant)
library(xts)
...
psych::describe(df_scaled)  # a quick look into the summary of the data. Library 'psych' attached
...
# Reshaping data into long format for ggplot
